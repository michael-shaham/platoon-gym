...
def parse_arguments():
    ...
    # Required arguments
    parser.add_argument("--controller", type=str, choices=["CCMPC", "DMPC"], required=True, help="Controller type.")
    ...
    parser.add_argument("--noise_std", type=float, default=0.0, help="Standard deviation of noise added to vehicle positions.")
    ...
    parser.add_argument("--r_ccmpc", type=float, default=10.0, help="Control effort weight for CCMPC.")
    ...
    parser.add_argument("--qms_ccmpc", type=float, default=100.0, help="Move suppression weight for CCMPC.")
    ...
    parser.add_argument("--attacked_vehicles", nargs="*", type=int, default=[], help="List of vehicle indices to be attacked.")
    parser.add_argument("--attack_times", nargs="*", type=float, default=[], help="List of attack times.")
...
def main():
    ...
    for _ in range(args.num_vehicles):
        backup_controllers.append(CCMPC)
        backup_controller_args_list.append(copy.deepcopy(ccmpc_args))
    ...
    log_filename += f"_{args.qms_ccmpc:.2f}_qms"
    log_filename += f"_{args.attack_frequency:.2f}_af_{args.attack_duration:.1f}s_ad.hdf5"
    simulation = PlatoonSimulation(
        ...
        attacked_vehicles=args.attacked_vehicles,
        attack_times=args.attack_times,
